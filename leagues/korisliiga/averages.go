...
type korisliigaAverages struct {
	Season      int
	Description string
	Wins,
	Loses,
...
// it returns slice of calculated korisiigaAverages
...
// name is used as Description in korisliigaAverages
func seasonAverages(s leagues.YearlyStnds, start, end int, name string) []korisliigaAverages {
	sAvg := []korisliigaAverages{}
